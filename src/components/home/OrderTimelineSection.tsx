...
export function OrderTimelineSection() {
  const steps = [
    {
      ...
      description:
        "Hubungi Admin via WhatsApp. Diskusikan konsep seragam (PDH, Vest, Kaos, Jaket), pilihan bahan (Nagata Drill, Canvas, dll.), kuantitas, dan estimasi biaya.",
    ...
    },
    {
      ...
      description:
        "Pembayaran DP 50% untuk konfirmasi slot produksi. Tim kreatif kami akan menyiapkan mockup 2D digital gratis hingga persetujuan final dari Anda.",
      icon: FileCheck2,
    },
    {
      id: "03",
      ...
      description:
        "Pemotongan kain, pembordiran komputer presisi tinggi, dan penjahitan profesional oleh spesialis konveksi berpengalaman (10 - 14 hari kerja).",
      icon: Hammer,
    },
    {
      id: "04",
      ...
      description:
        "Pengecekan Quality Control, pelunasan sisa tagihan 50%, dan paket dikirim aman ke alamat Anda via kurir atau diambil di workshop Jember.",
      icon: Truck,
    },
  ];
  ...
  return (
    <section
      ...
      className="py-20 md:py-28 bg-[#09090b] relative overflow-hidden border-t border-border/60"
    >
      {/* Background Soft Glow */}
      <div
        className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[500px] h-[500px] bg-yellow-500/5 rounded-full blur-3xl pointer-events-none"
        aria-hidden="true"
      ></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-28">
            <div className="flex items-center gap-2">
              <span className="h-[2px] w-6 bg-primary" aria-hidden="true"></span>
            ...
            <div className="pt-2">
              <a
                ...
                className="inline-flex items-center gap-3 pl-6 pr-2 py-2 rounded-full border border-zinc-700 bg-zinc-950 text-sm font-semibold text-white hover:border-primary transition-all group shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
              >
          ...
          <div className="lg:col-span-7 relative" ref={timelineRef}>
            <div className="relative pl-6 sm:pl-10 space-y-6 sm:space-y-8">
              ...
              <div className="absolute left-[9px] sm:left-[17px] top-6 bottom-8 w-[2px] bg-zinc-800" aria-hidden="true">
                <div
              ...
              {steps.map((step, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Step Content Card */}
                    <article
                      className={`rounded-2xl border bg-[#121215] p-6 sm:p-7 shadow-lg transition-all duration-500 ${
                        isActive
